"""Research agent's owned-tool name set.
...
the research agent, you only edit this file. agents/registry.py
reads this set when partitioning the MCP tool list into the
per-agent subsets.
"""

RESEARCH_TOOL_NAMES = frozenset({"analyzeAttendeeBackground", "searchWebInfo"})
